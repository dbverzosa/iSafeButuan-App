...
const BFireProtection = () => {
  const [modalVisible, setModalVisible] = useState(false);

  return (
    <View style={styles.container}>
      <Button title="Fire Protection CONTACTS" onPress={() => setModalVisible(true)} style={styles.modalButton} />
      <Modal
        animationType="slide"
        transparent={true}
...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'flex-end', // Right align horizontally
    marginTop: 50,
...
export default BFireProtection
